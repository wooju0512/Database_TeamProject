...
<body>
    ...
    <section class="banner-area text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6>세상에서 제일 맛있는 레시피 모음</h6>
                    <h1>우주의 비밀<span class="prime-color"> 레시피</span><br>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="section-top">
                        <h3><span class="style-change"></span> <br>레시피</h3>
                        </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="testimonial-slider owl-carousel">
                        <div class="single-slide d-sm-flex">
                            ...
                            <div class="customer-text">
                                <h5>권우주</h5>
                                <span><i>혼자사는 외로운 자취생</i></span>
                                </div>
                        </div>
                        <div class="single-slide d-sm-flex">
                            <div class="customer-img mr-4 mb-4 mb-sm-0">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ_kl3qN7qYkW8jSArfZ_OCCKSqt8GYnet4gw&usqp=CAU" alt="">
                            </div>
                            <div class="customer-text">
                                <h5>김민기</h5>
                                <span><i>백종원급 셰프</i></span>
                                 </div>
                        </div>
